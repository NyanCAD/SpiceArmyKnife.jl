...
#==============================================================================#
# Simulation Spec and Global State
#
# These are used by SpectreEnvironment for time-dependent functions and by
# the old DAECompiler-based devices. MNA uses MNASpec instead.
#==============================================================================#
...
#==============================================================================#
# ParallelInstances - Device Multiplier
#
# Used by spicecall() to handle M= parameter for parallel device instances.
#==============================================================================#
...
#==============================================================================#
# Named - Device Instance Naming
#
# Wraps a device with a name for debug/scope purposes.
#==============================================================================#
...
#==============================================================================#
# DAECompiler-specific Runtime
#
# The following code is only used when DAECompiler is enabled.
# MNA uses its own stamping-based approach instead.
#==============================================================================#
