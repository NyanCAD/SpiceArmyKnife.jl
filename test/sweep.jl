...
# nest_param_list and flatten_param_list are DAECompiler-only (from circuitodesystem.jl)
# Skip these tests since DAECompiler has been removed
@testset "nest and flatten param lists" begin
    @test_skip "nest_param_list requires DAECompiler"
end
